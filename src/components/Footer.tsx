...
export function Footer() {
  return (
    <footer className="relative py-6 md:py-8 bg-[#fbeede] flex flex-col items-center justify-center overflow-hidden border-t border-[#fbeede]/20 w-full">
      ...
      {/* Background Glows */}
      <div className="absolute top-0 right-[5%] w-32 h-32 bg-[#fbeede]/5 rounded-full blur-2xl pointer-events-none z-0" />
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-5">
        ...
        <a
          ...
          className="relative flex items-center justify-between gap-5 py-3 px-5 bg-[#380104]/85 backdrop-blur-md border border-[#fbeede]/25 hover:border-[#fbeede]/50 rounded-2xl transition-all duration-300 group shadow-md hover:shadow-lg hover:scale-[1.02] cursor-pointer max-w-sm w-full md:w-auto shrink-0 select-none overflow-hidden"
        >
          {/* Ticket Info */}
          <div className="flex flex-col text-left pl-1">
            <span className="text-[7.5px] uppercase tracking-[0.25em] text-[#fbeede] font-extrabold">Digital Invitation Design</span>
          ...
          {/* Action Button */}
          <div className="bg-[#FAF4EA] text-[#380104] px-4 py-2 rounded-xl text-[9.5px] uppercase tracking-wider font-extrabold shadow-xs group-hover:bg-[#fbeede] group-hover:text-[#380104] transition-all shrink-0 flex items-center gap-1.5 border border-white/5">
            <span>Contacto</span>
            <svg
